...
@section('contenido')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Registrar una iniciativa</h2>
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" action="{{ route('iniciativa.store', $id_ind) }}" id="demo-form2"
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 offset-md-3">
                                ...
                                <a href="{{ route('cancelainiciativa', $id_ind) }}" class="btn btn-primary"
