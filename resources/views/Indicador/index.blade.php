...
@section('contenido')
    ...
    @endphp
    <div class="container">
        <h2 class="text-center fs-3 fw-bolder">LISTA DE INDICADORES</h2>
        <a href="{{ route('indicador.create', $_SESSION['ruc']) }}" class="btn btn-primary"><i
                class="fa fa-plus-square-o"></i> Nuevo Registro</a>
        ...
        <table class="table table-bordered">
            <thead>
                <tr class="table-primary">
                    ...
                    <th scope="col" class="text-center">Subproceso</th>
                    <th scope="col" class="text-center">Descripción</th>
                    <th scope="col" class="text-center">Responsable</th>
                    <th scope="col" class="text-center" style="width: 270px;">Opciones</th>
                </tr>
            </thead>
            <tbody>
                @php
                ...
                @foreach ($indicador as $item)
                    <tr>
                        ...
                        <td class="table-light">
                            ...
                            <a href="{{ route('indicador.show', $item->ind_id) }}" class="btn btn-danger btn-sm"><i
                                    class="fa fa-trash"></i>Eliminar</a>
                            <a href="{{ route('iniciativa.index', $item->ind_id) }}"
                                class="btn btn-primary btn-sm">Iniciativa</a>
                        </td>
                    </tr>
                    @php
                        $int = $int + 1;
