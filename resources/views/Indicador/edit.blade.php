    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" action="{{ route('indicador.update', $indicador->ind_id) }}" id="demo-form2"
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-8">
                                <select id="subproceso" name="subproceso" class="form-control" required>
                                    @foreach ($subproceso as $item)
                                        @if ($item->sub_id == $indicador->sub_id)
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-8">
                                <input type="text" id="descripcion" name="descripcion" required="required"
                                    class="form-control" value="{{ $indicador->ind_nombre }}">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 col-lg-2 label-align"
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-8">
                                <input type="text" id="responsable" name="responsable" required="required"
                                    class="form-control" value="{{ $indicador->ind_responsable }}">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 col-lg-2 label-align" for="first-name">Objetivo
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-lg-8">
                                <input type="text" id="objetivo" name="objetivo" required="required" class="form-control"
                                    value="{{ $indicador->ind_objetivo }}">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 col-lg-2 label-align" for="first-name">Meta
                                <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-lg-8">
                                <input type="text" id="meta" name="meta" required="required" class="form-control"
                                    value="{{ $indicador->ind_meta }}">
                            </div>
                        </div>
                        <div class="item form-group">
