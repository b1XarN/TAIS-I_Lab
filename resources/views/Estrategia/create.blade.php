...
@section('contenido')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Registrar una Estrategias</h2>
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" action="{{route('estrategia.store', $subproceso->sub_id)}}" id="demo-form2"
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 offset-md-3">
                                ...
                                <a href="{{ route('cancelaestrategia', $subproceso->sub_id) }}" class="btn btn-primary"
