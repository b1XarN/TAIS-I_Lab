            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Gestionar Usuarios <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Registrar usuario</a></li>
                      <li><a href="index2.html">Listar usuarios</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Gestionar Empresas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
